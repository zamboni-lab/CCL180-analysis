...
setwd('MetabCCLs/code/TreeEnrichment')
...
# Load Pathway Score
PCAHeatMap = read.csv("../../data/PathwayScore_180CCL.csv",
                      header = TRUE,
                      row.names = 'X')
...
ha = HeatmapAnnotation(Tissue = CellLinesMeta$V4,
                       Batch = Batch1,
                       col = list(
                         Batch = c(
                           "1" = "#BB7E98",
...
Confluency = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  CellLinesMeta$V3[removingSuspensionCells],
  'Confluency',
  t(CellLinesMeta$V1[removingSuspensionCells]),
  LOG_10 = FALSE,
  MinSizeCLuster = 18
)
pvalposlist = TreeEnrichment_Stats(
  Heatamp_clust_,
  CellLinesMeta$V3[removingSuspensionCells],
  t(CellLinesMeta$V1[removingSuspensionCells]),
  LOG_10 = FALSE,
...
for (i in 1:length(batch)) {
  BatchTmp = TreeEnrichment_Qual_Stat(Heatamp_clust_, CellLinesMeta$V1[CellLinesMeta$V2 ==
                                                                         batch[i]], CellLinesMeta$V1)
...
for (i in 1:length(tissue)) {
  TissueTmp = TreeEnrichment_Qual_Stat(Heatamp_clust_, CellLinesMeta$V1[CellLinesMeta$V4 ==
                                                                          tissue[i]], CellLinesMeta$V1)
...
## Metadata from CCLE
CellLinesAnnotation = read.csv(
  "../../data/CellLinesMeta_CCLE.csv",
  header = TRUE,
...
for (i in 1:length(pathology)) {
  cellsSelected = CellLinesAnnotation$NameAstra[CellLinesAnnotation$Pathology ==
                                                  pathology[i]]
...
for (i in 1:length(histology)) {
  cellsSelected = CellLinesAnnotation$NameAstra[CellLinesAnnotation$Histology ==
                                                  histology[i]]
  cellsSelected = na.omit(cellsSelected)
  cellsSelected = fixlc(cellsSelected)
  cellsSelected = cellsSelected[cellsSelected != ""]
...
for (i in 1:length(histologysubtype)) {
  cellsSelected = CellLinesAnnotation$NameAstra[CellLinesAnnotation$Hist_Subtype1 ==
                                                  histologysubtype[i]]
  cellsSelected = na.omit(cellsSelected)
  cellsSelected = fixlc(cellsSelected)
  cellsSelected = cellsSelected[cellsSelected != ""]
...
for (i in 1:length(type1)) {
  cellsSelected = CellLinesAnnotation$NameAstra[CellLinesAnnotation$type ==
                                                  type1[i]]
  cellsSelected = na.omit(cellsSelected)
  cellsSelected = fixlc(cellsSelected)
  cellsSelected = cellsSelected[cellsSelected != ""]
...
for (i in 1:length(ethnicity)) {
  cellsSelected = CellLinesAnnotation$NameAstra[CellLinesAnnotation$inferred_ethnicity ==
                                                  ethnicity[i]]
  cellsSelected = na.omit(cellsSelected)
  cellsSelected = fixlc(cellsSelected)
  cellsSelected = cellsSelected[cellsSelected != ""]
...
MutationRateEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  CellLinesAnnotation$mutRate[pos],
  'MutationRate',
  cellsSelected,
  LOG_10 = FALSE,
  MinSizeCLuster = 18
...
MethylationEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  meth_features[CellLines_Met_InAstra, ],
  colnames(meth_features),
  CellLines_Met[CellLines_Met_InAstra],
  LOG_10 = FALSE,
  MinSizeCLuster = 18
)
...
CNEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  CN_features[CellLines_CN_InAstra, ],
  colnames(CN_features),
  CellLines_CN[CellLines_CN_InAstra],
  LOG_10 = FALSE,
  MinSizeCLuster = 18
)
...
transcriptomicsAstra = readMat('../../data/Transcripts_Astra.mat')
transcriptomicsAstra = transcriptomicsAstra$transcriptomicsAstra
GeneSelectedTrans = readMat('../../data/Transcripts_list.mat')
GeneSelectedTransEnsembl <-
  sapply(GeneSelectedTransEnsembl[[1]], function(n)
    n[[1]])
CellLineSelectedTrans = readMat('../../data/Transcripts_cellline.mat')
CellLineSelectedTrans <-
  sapply(CellLineSelectedTrans[[1]], function(n)
    n[[1]])

TranscriptsEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  transcriptomicsAstra,
  GeneSelectedTrans,
  CellLineSelectedTrans,
  LOG_10 = FALSE,
  MinSizeCLuster = 18
...
TF_list <- sapply(TF_list[[1]], function(n)
  n[[1]])
TF_cellline = readMat('../../data/TF_cellline.mat')
TF_cellline <- sapply(TF_cellline[[1]], function(n)
  n[[1]])

TFEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  t(TF_activity_Astra),
  TF_list,
  TF_cellline,
...
EMT_cellline <- sapply(EMT_cellline[[1]], function(n)
  n[[1]])

EMTEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  EMT_TransitionAstra,
  'EMT',
  EMT_cellline,
...
Protein_list <- sapply(Protein_list[[1]], function(n)
  n[[1]])
Protein_cells_Astra = readMat('../../data/Protein_cells_Astra.mat')
Protein_cells_Astra <-
  sapply(Protein_cells_Astra[[1]], function(n)
    n[[1]])

ProteinEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  t(Protein_Levels_Astra),
  Protein_list,
  Protein_cells_Astra,
  LOG_10 = FALSE,
  MinSizeCLuster = 18
...
Prog_Pathways <- sapply(Prog_Pathways[[1]], function(n)
  n[[1]])
Proj_cellline = readMat('../../data/Proj_cellline.mat')
Proj_cellline <- sapply(Proj_cellline[[1]], function(n)
  n[[1]])

ProgEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  t(Prog_Activity_Astra),
  Prog_Pathways,
  Proj_cellline,
  LOG_10 = FALSE,
  MinSizeCLuster = 18
...
GrowthRate_Astra <-
  sapply(GrowthRate_Astra[[1]], function(n)
    n[[1]])
GrowthRate_cellline = readMat('../../data/GrowthRate_cells_Astra.mat')
GrowthRate_cellline <-
  sapply(GrowthRate_cellline[[1]], function(n)
    n[[1]])

GREnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  t(GrowthRate_Astra),
  'GrowthRate',
  GrowthRate_cellline,
...
Protein_list_MS <- sapply(Protein_list_MS[[1]], function(n)
  n[[1]])
...
Protein_cells_MS_Astra <-
  sapply(Protein_cells_MS_Astra[[1]], function(n)
    n[[1]])

ProtMSEnrich = TreeEnrichment_Wrapper_ALL(
  Heatamp_clust_,
  t(Protein_Levels_MS_Astra2),
  Protein_list_MS2,
  Protein_cells_MS_Astra,
  LOG_10 = FALSE,
  MinSizeCLuster = 18
...
pvalMerged = c(
  ConfluencySusCells[[1]],
  Confluency[[1]],
  BatchEnrich[[1]],
  TissueEnrich[[1]],
  PathologyEnrich[[1]],
  HistologyEnrich[[1]],
  HistologySubtypeEnrich[[1]],
  TypeEnrich[[1]],
  EthnicityEnrich[[1]],
  MutationRateEnrich[[1]],
  MutationEnrich[[1]],
  MethylationEnrich[[1]],
  CNEnrich[[1]],
  TFEnrich[[1]],
...
TreeEnrichment_Sus = TreeEnrichment_Visualisation_ALL(
  Heatamp_clust_,
  corpval_ConfluencySusCells,
  ConfluencySusCells[[2]],
  'Suspension',
  TRUE
)
...
TreeEnrichment_Conf = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                       corpval_Confluency,
                                                       Confluency[[2]],
                                                       'Confluency',
                                                       TRUE)
...
TreeEnrichment_TissueEnrich = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                               corpval_TissueEnrich,
                                                               TissueEnrich[[2]],
                                                               tissue,
                                                               TRUE)
...
TreeEnrichment_PathologyEnrich = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                                  corpval_PathologyEnrich,
                                                                  PathologyEnrich[[2]],
                                                                  pathology,
                                                                  TRUE)
...
TreeEnrichment_Histology = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                            corpval_HistologyEnrich,
                                                            HistologyEnrich[[2]],
                                                            histology,
                                                            TRUE)
...
TreeEnrichment_HistologySubtypeEnrich = TreeEnrichment_Visualisation_ALL(
  Heatamp_clust_,
  corpval_HistologySubtypeEnrich,
  HistologySubtypeEnrich[[2]],
  histologysubtype,
  TRUE
)
...
TreeEnrichment_EthnicityEnrich = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                                  corpval_EthnicityEnrich,
                                                                  EthnicityEnrich[[2]],
                                                                  ethnicity,
                                                                  TRUE)
...
TreeEnrichment_MutationRateEnrich = TreeEnrichment_Visualisation_ALL(
  Heatamp_clust_,
  corpval_MutationRateEnrich,
  MutationRateEnrich[[2]],
  'Mutation Rate',
  TRUE
)
...
TreeEnrichment_MutationEnrich = TreeEnrichment_Visualisation_ALL(
  Heatamp_clust_,
  corpval_MutationEnrich,
  MutationEnrich[[2]],
  colnames(mut_features),
  FALSE
)
...
matMut = rbind(TreeEnrichment_MutationEnrich[signMut2, ],
               TreeEnrichment_MutationEnrich[signMut2, ])
...
TreeEnrichment_MethylationEnrich = TreeEnrichment_Visualisation_ALL(
  Heatamp_clust_,
  corpval_MethylationEnrich,
  MethylationEnrich[[2]],
  colnames(meth_features),
  FALSE
)
...
heatmap.2(
  TreeEnrichment_MethylationEnrich[signMet2, ],
  dendrogram = 'none',
  Rowv = TRUE,
  Colv = FALSE,
...
TreeEnrichment_CNEnrich = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                           corpval_CNEnrich,
                                                           CNEnrich[[2]],
                                                           colnames(CN_features),
                                                           FALSE)
...
heatmap.2(
  TreeEnrichment_CNEnrich[c(signCN2, signCN2), ],
  dendrogram = 'none',
  Rowv = TRUE,
  Colv = FALSE,
  trace = 'none',
...
heatmap.2(
  TreeEnrichment_TFEnrich[signTF2, ],
  dendrogram = 'none',
  Rowv = TRUE,
  Colv = FALSE,
  hclustfun = function(x)
...
TreeEnrichment_ProteinEnrich = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                                corpval_ProteinEnrich,
                                                                ProteinEnrich[[2]],
                                                                Protein_list,
                                                                FALSE)
# To get only significant
...
heatmap.2(
  TreeEnrichment_ProteinEnrich[signProt2, ],
  dendrogram = 'none',
  Rowv = TRUE,
  Colv = FALSE,
  trace = 'none',
...
TreeEnrichment_ProgEnrich = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                             corpval_ProgEnrich,
                                                             ProgEnrich[[2]],
                                                             Prog_Pathways,
                                                             TRUE)
...
TreeEnrichment_TranscriptsEnrich = TreeEnrichment_Visualisation_ALL(
  Heatamp_clust_,
  corpval_TranscriptsEnrich,
  TranscriptsEnrich[[2]],
  GeneSelectedTrans,
  FALSE
)
...
heatmap.2(
  TreeEnrichment_TranscriptsEnrich[signTranscripts2, ],
  dendrogram = 'none',
  Rowv = TRUE,
  Colv = FALSE,
  trace = 'none',
...
TreeEnrichment_ProteinMSEnrich = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                                  corpval_ProteinMSEnrich,
                                                                  ProtMSEnrich[[2]],
                                                                  Protein_list_MS2,
                                                                  FALSE)
# To get only significant
...
heatmap.2(
  TreeEnrichment_ProteinMSEnrich[signProteinMS2, ],
  dendrogram = 'none',
  Rowv = TRUE,
  Colv = FALSE,
  trace = 'none',
...
TreeEnrichment_GREnrich = TreeEnrichment_Visualisation_ALL(Heatamp_clust_,
                                                           corpval_GREnrich,
                                                           GREnrich[[2]],
                                                           'Growth Rate',
                                                           TRUE)
...
# To merge table
MergedDataEnrich = rbind(
  TreeEnrichment_Conf,
  TreeEnrichment_BatchEnrich,
  TreeEnrichment_Sus,
  TreeEnrichment_TissueEnrich,
  rep(0, 180),
  matMut,
  rep(0, 180),
  TreeEnrichment_CNEnrich[signCN2, ]
)
...
MergedDataAll = rbind(
  ...
  TreeEnrichment_MethylationEnrichClean[MethylToKeep, ],
  rep(0, 180),
  TreeEnrichment_TranscriptsClean[TranscriptsToKeep[a[["rowInd"]]], ],
  rep(0, 180),
  TreeEnrichment_ProteinEnrichClean[ProteinToKeep[b[["rowInd"]]], ],
  rep(0, 180),
  TreeEnrichment_TFEnrichClean[TFToKeep[c[["rowInd"]]], ],
  rep(0, 180),
  TreeEnrichment_ProgEnrich[c(7, 9), ],
  rep(0, 180),
  TreeEnrichment_EMTEnrich
...
MergedData_Publication = rbind(
  TreeEnrichment_Conf,
  TreeEnrichment_BatchEnrich,
  TreeEnrichment_Sus,
  rep(0, 180),
  TreeEnrichment_TissueEnrich,
  TreeEnrichment_PathologyEnrich,
  TreeEnrichment_Histology,
  TreeEnrichment_HistologySubtypeEnrich,
  TreeEnrichment_TypeEnrich,
  TreeEnrichment_EthnicityEnrich,
  TreeEnrichment_MutationRateEnrich,
  rep(0, 180),
  TreeEnrichment_MutationEnrich,
  rep(0, 180),
  TreeEnrichment_CNEnrich,
  rep(0, 180),
  TreeEnrichment_MethylationEnrich,
  rep(0, 180),
  TreeEnrichment_TranscriptsEnrich,
  rep(0, 180),
  TreeEnrichment_ProteinEnrich,
  rep(0, 180),
  TreeEnrichment_TFEnrich,
  rep(0, 180),
  TreeEnrichment_ProgEnrich,
  rep(0, 180),
  TreeEnrichment_EMTEnrich
)
MergedData_Publication_2 = 10 ^ (-abs(MergedData_Publication))
MergedData_Publication_3 = (as.integer(MergedData_Publication >= 0) * 2 -
                              1) * MergedData_Publication_2


write.csv(MergedData_Publication_3,
          'TreeEnrichment_OmicsIntegration_All.csv')
...
write.csv(MergedDataAll_3,
          'TreeEnrichment_OmicsIntegration_Significant.csv')
